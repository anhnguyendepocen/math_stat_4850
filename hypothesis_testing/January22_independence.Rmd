...
We wish to test whether being bullied and being short are independent. We create a new data frame that has `sum(bully_data)` rows. This is a bit tricky to do by hand, but there is a specialized package that can help us.
